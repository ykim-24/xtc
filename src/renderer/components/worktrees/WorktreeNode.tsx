...
export type WorktreeStatus = 'idle' | 'running' | 'success' | 'error';
  ...
  return (
    ...
    >
      ...
      `}>
        ...
        `}>
          <GitBranch className={`w-4 h-4 ${isCurrent ? 'text-accent-primary' : 'text-text-muted'}`} />
          <span className={`
